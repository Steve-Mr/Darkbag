                ...
                try {
                    ...
                    if (isJpg) {
                        ...
                        if (!isHalfFrame) {
                            ...
                            val bytes1 = if (dngFile1.exists()) java.io.FileInputStream(dngFile1).use { it.readBytes() } else null
                            val bytes2 = if (dngFile2.exists()) java.io.FileInputStream(dngFile2).use { it.readBytes() } else null
                            ...
                            var composite = top.maary.darkbag.utils.HalfFrameUtils.processAndComposeHalfFrame(
                                ...
                                bytes1 = bytes1, uri1 = dngUri1,
                                bytes2 = bytes2, uri2 = dngUri2,
                                config = config,
                                logIndex = logIndex,
                                lutPath = lutPath,
